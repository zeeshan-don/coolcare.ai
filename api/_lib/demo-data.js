...
function generateNotifications() {
  const notifications = [
    ...
    { type: "payment", title: "Subscription Renewed", message: "Monthly subscription of ₹1,700 renewed successfully.", icon: "🔄" },
...
function buildDemoSubscriptionResponse() {
  ...
  return {
    ...
    plans: [
      { id: 1, name: "Starter", display_name: "Starter", price_monthly: 1300, price_yearly: 12500, features: ["Basic Dashboard", "50 Bookings/mo", "Email Support"], is_active: true },
      { id: 2, name: "Pro", display_name: "Pro", price_monthly: 1700, price_yearly: 16500, features: ["AI Chatbot", "WhatsApp Integration", "Unlimited Bookings", "Team Accounts", "Analytics"], is_active: true },
    ],
    payments: [
      { id: 1, invoice_number: "INV-DEMO-0000", amount: 16500, currency: "INR", status: "completed", gateway: "demo", description: "CoolCare Pro — Yearly Subscription (Demo)", created_at: ago(30) },
    ],
    isDemo: true,
  };
}
